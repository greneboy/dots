...
static const char dmenuhp[] 	= "firefox,discord,pavucontrol,thunar";
...
static const char *voldw[]		= { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-2%", NULL };
static const char *volmt[]		= { "pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle", NULL };
static const char *micmt[]		= { "pactl", "set-source-mute", "@DEFAULT_SOURCE@", "toggle", NULL };
static const char *briup[]		= { "brightnessctl", "set", "+10%", NULL };
static const char *bridw[]		= { "brightnessctl", "set", "10%-", NULL };
...
static const Key keys[] = {
	...
	{ 0,							XF86XK_MonBrightnessDown,		spawn,			{.v = bridw } },
	{ 0,							XF86XK_Display,					spawn,			SHCMD("display-menu") },
	{ 0,							XF86XK_PowerOff,				spawn,			SHCMD("session-menu") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
